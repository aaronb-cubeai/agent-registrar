...
└── Auditor Agent              # Reviews all agents weekly, leaves improvement notes
    ...
    ├── Sales Research Agent   # Prospect list building, contact enrichment, Excel exports
    ...
    └── BD Re-engagement Monitor # Daily post-meeting deal monitoring, BD check-in prompts
```
...
| Sales Research Agent | Prospect list building, contact enrichment, Excel exports | [agents/sales-research-agent.md](agents/sales-research-agent.md) | Active |
...
| BD Re-engagement Monitor | Daily post-meeting deal monitoring, BD check-in prompts in Slack | [agents/bd-reengagement-monitor.md](agents/bd-reengagement-monitor.md) | Active |
